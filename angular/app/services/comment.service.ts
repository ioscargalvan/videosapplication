...
export class CommentService {
  ...
  getCommentsOfVideo(video_id) {
    return this._http.get(this.url + "/comment/list/" + video_id).map(res => res.json());
  }
  ...
  delete(token, id) {
    ...
    return this._http.post(this.url + "/comment/delete/" + id, params, {headers: headers}).map(res => res.json());
  }
